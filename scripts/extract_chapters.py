...
CHAPTERS = [
    ...
    ("ch-02", "第 2 章 投资者与通货膨胀", 47, 58),
    ("ch-03", "第 3 章 一个世纪的股市历史：1972 年年初的股价水平", 59, 74),
    ("ch-04", "第 4 章 防御型投资者的投资组合策略", 75, 90),
    ("ch-05", "第 5 章 防御型投资者与普通股", 91, 102),
    ("ch-06", "第 6 章 积极型投资者的证券组合策略：被动的方法", 103, 115),
    ("ch-07", "第 7 章 积极型投资者的证券组合策略：主动的方法", 116, 140),
    ("ch-09", "第 9 章 基金投资", 167, 184),
